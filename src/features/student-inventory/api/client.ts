...
import type { InventoryHistoryRow, InventoryKind, StudentInventoryItem } from "@/entities/student-inventory/model/types";
import { httpJson } from "@/shared/api/http";
import { API_ROUTES } from "@/shared/api/routes";

import type { StudentInventoryDto, IssueRequestDto, IssueResponseDto, ReturnRequestDto, ReturnResponseDto, InventoryLogDto } from "../model/contracts";
